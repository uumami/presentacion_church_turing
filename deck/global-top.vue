...
// ========================================
// bottom ticker (green, right-to-left)
// ========================================
const tickerItems = [
  'uumami',
  'ヽ(°◇° )ノ',
  ...
  '🏳️‍🌈',
  '¯\\_(ツ)_/¯',
  'sin respuesta. y está bien.',
]
const tickerLoop = [...tickerItems, ...tickerItems]

// ========================================
// top ticker: boot-log style (cyan)
// ========================================
const topItems = [
  '[ok] turing machine initialized',
  '━━━━━━▶',
  'δ: Q × Γ → Q × Γ × {L,R}',
  '[▓▓▓▓▓▓▓▓░░] 80%',
  '[ok] λ-calculus loaded',
  '◢◣  ◥◤',
  ...
  '▒▒▓▓▓▓▒▒',
  '[ok] entscheidungsproblem: nein',
  '(>‿◠)✌',
  '[ok] von neumann noted',
  '🏳️‍🌈',
...
// ambient glyphs
// ========================================
const glyphChars = '人線繋鏡夢永無心時空#∞◊◈◉◎ンルλδ∀∃'.split('')
const glyphs = ref([])
let glyphTimer = null
